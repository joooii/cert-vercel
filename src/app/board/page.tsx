...
export default function BoardPage() {
  ...
  const getPriorityIcon = (priority: string) => {
    switch (priority) {
      case "high":
        return <AlertTriangleSVG className="w-4 h-4 text-red-600" />;
      case "medium":
        return <InfoSVG className="w-4 h-4 text-yellow-600" />;
      default:
        return <ChatSVG className="w-4 h-4 text-blue-600" />;
    }
  };
    ...
    <>
      ...
      {filteredPosts.length === 0 && (
        <div className="text-center py-12">
          <ShieldSVG className="w-16 h-16 text-gray-300 mx-auto mb-4" />
