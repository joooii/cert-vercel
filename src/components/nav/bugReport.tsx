...
export default function BugReport({ className = "" }: { className?: string }) {
  return (
    <a
      ...
      className={`flex items-center px-3 py-1.5 group text-sm border border-cert-dark-red rounded-md transition-all duration-300 shadow-cert-navbar hover:shadow-lg hover:bg-cert-red/10 hover:border-cert-dark-red whitespace-nowrap ${className}`}
    >
